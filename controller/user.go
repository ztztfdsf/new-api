...
func Register(c *gin.Context) {
	...
	if err := model.MarkInvitationUsed(req.InvitationCode, insertedUser.Id); err != nil {
		common.SysLog(fmt.Sprintf("failed to mark invitation code used: %v", err))
	}
